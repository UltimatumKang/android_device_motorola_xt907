...
#device
$(call inherit-product-if-exists, device/motorola/xt907/full_xt907.mk)
...
PRODUCT_NAME := ukg_xt907
PRODUCT_MODEL := Droid Razr M
PRODUCT_MANUFACTURER := Motorola
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.xt907.$(shell date +%m%d%y).$(shell date +%H%M%S)
